...
class DataTransformation:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            # Remove rows with missing target values before scaling and sampling
            target_feature_train_df = target_feature_train_df.dropna()
            input_feature_train_df = input_feature_train_df.loc[target_feature_train_df.index]

            target_feature_test_df = target_feature_test_df.dropna()
            input_feature_test_df = input_feature_test_df.loc[target_feature_test_df.index]
            ...
            logging.info("SMOTEENN applied to train df only.")
